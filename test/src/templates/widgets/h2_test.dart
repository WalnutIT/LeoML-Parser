...
void main() {
  group('Positive test', () {
    testWidgets('h2 shows the correct text', (tester) async {
      // given
      const textToDisplay = 'test text';

      // when
      const widget = MaterialApp(
        home: H2(object: {h2: textToDisplay}),
      );
  ...
  group('Negative test', () {
    test('Atomic object validation fails', () {
      ...
      const expectedMessage =
          '\'h2\' is not from type String. Atomic objects must have the data type \'String\'';
      // when
      const widget = H2(object: {h1: textToDisplay});
